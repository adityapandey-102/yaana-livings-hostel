...
const FAQ = [
  {
    q: "Why choose yaanalivings?",
    a: "We offer a wide range from hostels and PGs to studio apartments and fully furnished flats, with 10X better living: Smart KYC, digital payments, tenant app, and complimentary tenant insurance.",
  },
  {
    q: "How secure are the properties?",
    a: "All our properties feature 24/7 security, CCTV, and controlled access. Your safety and peace of mind are our priorities.",
  },
  {
    q: "What should I know before choosing accommodation?",
    a: "Consider location, budget, room type (single, double, triple), and included amenities. We help you compare options and arrange visits.",
  },
  {
    q: "How do I get to the property?",
    a: "We share exact coordinates and directions after you express interest. Most of our properties are well connected by public transport.",
  },
];
  ...
  return (
    <div>
      ...
      <section className="relative py-16 lg:py-24 bg-yaana-nearblack overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 mt-4 text-sm sm:text-base">
            yaanalivings redefines hostel living with a touch of luxury, crafted
            for students and young professionals. Ideally located near top
            educational hubs, we offer an inspiring space complete with
      ...
      <section className="relative py-8">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
            <div>
              <h1 className="text-2xl md:text-3xl font-semibold text-yaana-charcoal">
                {p.name}
              </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="flex flex-col gap-4">
              {sideImages.map((src, i) => (
                <div
                  key={i}
                  className="aspect-[4/3] relative rounded-card overflow-hidden"
                >
                  <Image
                    src={src}
                    alt=""
          ...
          {p.priceLabel === "For rent" ? (
            <p className="text-yaana-charcoal font-semibold text-xl">
              For rent, {p.price}
            </p>
          ) : (
            <>
              <p className="text-yaana-charcoal/70 text-sm">
                {p.priceLabel ?? "Starts from"}
              </p>
              <p className="text-yaana-charcoal font-semibold text-xl">
                {p.price}/mo*
              </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h2 className="text-xl font-semibold text-yaana-charcoal mb-4">
          About {p.name}
        </h2>

        <div className="text-yaana-charcoal/90 space-y-4">
          <p>
            Yaana Living provides a wide range of options from hostels, PGs to
            studio apartments to fully furnished flats. This property offers
            comfort, convenience, and community—high-speed WiFi, gym,
            housekeeping, and more.
          </p>
          <p>
            Our spaces are designed for students and young professionals. With
            Smart KYC, digital rent payments, and our tenant app, we make
            moving in and living hassle-free. Experience 10X better living at
            yaanalivings.
          </p>
        </div>
      </section>
      ...
      {/* AMENITIES */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-lavender-200">
        <h2 className="text-lg font-semibold text-yaana-charcoal mb-6">
          Amenities
        </h2>
        ...
        <div className="flex flex-wrap gap-8">
          {AMENITIES.map(({ icon: Icon, label }) => (
            <div key={label} className="flex flex-col items-center text-center">
              ...
              <span className="text-sm text-yaana-charcoal/90">
                {label}
              </span>
            </div>
          ))}
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 border-t border-lavender-200">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          {LIFE_IMAGES.map((src, i) => (
            <div
              key={i}
              className="w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden relative"
            >
              <Image
                src={src}
                alt=""
      ...
      {/* CONTACT */}
      <section className="relative py-12 bg-lavender-50">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <Link
            href="/rental"
            className="inline-block bg-lavender-600 text-white px-6 py-2.5 rounded-btn font-medium hover:bg-lavender-700"
          >
            ← All properties
          </Link>
        </div>
