...
export function LavenderPairOneCorners({ className = "" }: Props) {
  return (
    <>
      <Image
        src="/assets/flower-cutouts/lavender1-topLeft-corner.png"
        alt=""
        aria-hidden="true"
        width={768}
        height={768}
      ...
      />
      <Image
        src="/assets/flower-cutouts/lavender1-bottomRight-corner.png"
        alt=""
        aria-hidden="true"
        width={768}
        height={768}
